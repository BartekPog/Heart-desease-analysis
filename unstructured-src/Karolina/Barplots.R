...
arg7 <- table(restecg)
barplot(arg7, col = rainbow(20), xlab = "Wykonanie testu EKG (1 = wykonano, 0 = nie wykonano)", ylab = "Liczba badanych", main = "Wykres zależności liczby badanych osób od wykonania testu EKG")
